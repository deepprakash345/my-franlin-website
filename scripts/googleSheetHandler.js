...
try {
    ...
    // const spreadsheetId = process.argv[4].replace("gdrive:","");
    // const columnRange = process.argv[3];
    // const headerNames = process.argv[2];
    ...
    async function doWork() {
        ...
        //     submittedDataObj[headerNames[i]] = submittedData[i];
        // }
